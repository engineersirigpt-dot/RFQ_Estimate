...
// ผูกเฉพาะ 127.0.0.1 = เข้าได้จากเครื่องนี้เท่านั้น (คนในวง LAN เข้าไม่ได้แม้รู้ IP)
// ถ้าต้องการเปิดให้เครื่องอื่นในวงเข้าได้ ให้ลบ '127.0.0.1' ออก
const server = app.listen(PORT, '127.0.0.1', () => {
	console.log(`Server is running on http://127.0.0.1:${PORT} (localhost-only)`)
})
