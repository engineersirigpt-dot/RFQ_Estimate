...
**สูตรคำนวณ Layout Size :**
```
ถ้า W_side ≤ L_side:
    layout_width  = W_side + shortSideComponent
    layout_length = L_side + longSideComponent
มิฉะนั้น:
    layout_width  = W_side + longSideComponent
    layout_length = L_side + shortSideComponent
```
...
```
price = proof_price_per_component × qty (1)
```
